        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8 relative">
            ...
            <div className="relative bg-card/50 backdrop-blur-sm p-8 rounded-2xl border-2 border-border shadow-xl">
              <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent">Admin Dashboard</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border-blue-200 dark:border-blue-800/50 hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-gray-900 dark:text-white">15,234</div>
                <p className="text-xs text-gray-600 dark:text-gray-400 flex items-center mt-2 gap-1">
                  ...
                  <span className="font-semibold text-green-600 dark:text-green-500">+12.5%</span> from last month
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border-emerald-200 dark:border-emerald-800/50 hover:shadow-xl transition-all hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium text-gray-900 dark:text-white">Active Freelancers</CardTitle>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-gray-900 dark:text-white">10,482</div>
                <p className="text-xs text-gray-600 dark:text-gray-400 flex items-center mt-2 gap-1">
                  <TrendingUp className="h-3 w-3 text-green-600 dark:text-green-500" />
                  <span className="font-semibold text-green-600 dark:text-green-500">+8.2%</span> from last month
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-amber-200 dark:border-amber-800/50 hover:shadow-xl transition-all hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium text-gray-900 dark:text-white">Total Jobs</CardTitle>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-gray-900 dark:text-white">8,945</div>
                <p className="text-xs text-gray-600 dark:text-gray-400 flex items-center mt-2 gap-1">
                  <TrendingUp className="h-3 w-3 text-green-600 dark:text-green-500" />
                  <span className="font-semibold text-green-600 dark:text-green-500">+15.7%</span> from last month
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 border-purple-200 dark:border-purple-800/50 hover:shadow-xl transition-all hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium text-gray-900 dark:text-white">Revenue (M-Pesa)</CardTitle>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-gray-900 dark:text-white">KSh 2.8M</div>
                <p className="text-xs text-gray-600 dark:text-gray-400 flex items-center mt-2 gap-1">
                  <TrendingUp className="h-3 w-3 text-green-600 dark:text-green-500" />
                  <span className="font-semibold text-green-600 dark:text-green-500">+22.3%</span> from last month
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Tabs defaultValue="users" className="space-y-6">
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-start justify-between">
                        <div className="flex gap-4 flex-1">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-lg mb-1">Freelancer Name {i}</h3>
            ...
            <TabsContent value="jobs" className="space-y-4">
              <h2 className="text-2xl font-bold mb-4">Job Listings Management</h2>
              <Card>
                <CardContent className="pt-6">
            ...
            <TabsContent value="payments" className="space-y-4">
              <h2 className="text-2xl font-bold mb-4">Payment Transactions (M-Pesa)</h2>
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold">Annual Freelancer Fee</h3>
