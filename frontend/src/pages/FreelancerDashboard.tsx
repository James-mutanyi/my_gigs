...
const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    date: "2 days ago",
    content: "Excellent work! Professional and delivered on time. Highly recommend!",
    helpful: 12,
    verified: true,
  },
  {
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8 relative">
            ...
            <div className="relative bg-card/50 backdrop-blur-sm p-8 rounded-2xl border-2 border-border shadow-xl">
              ...
              <p className="text-muted-foreground text-lg">Here's what's happening with your freelance work</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/50 bg-gradient-to-br from-card to-primary/5">
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-1 text-xs text-muted-foreground">
                  ...
                  <span className="text-green-600 dark:text-green-500 font-semibold">+2</span> from last month
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-secondary/50 bg-gradient-to-br from-card to-secondary/5">
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-1 text-xs text-muted-foreground">
                  <TrendingUp className="h-3 w-3 text-green-600 dark:text-green-500" />
                  <span className="text-green-600 dark:text-green-500 font-semibold">+18%</span> this week
                </div>
              </CardContent>
            </Card>

            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-accent/50 bg-gradient-to-br from-card to-accent/5">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-1 text-xs text-muted-foreground">
                  <TrendingUp className="h-3 w-3 text-green-600 dark:text-green-500" />
                  <span className="text-green-600 dark:text-green-500 font-semibold">+12%</span> this month
                </div>
              </CardContent>
            </Card>
          ...
          <Tabs defaultValue="jobs" className="space-y-6">
            <TabsList className="grid w-full grid-cols-4 p-1 bg-muted/50 backdrop-blur-sm h-auto">
              <TabsTrigger value="jobs" className="data-[state=active]:bg-card data-[state=active]:shadow-lg">
                My Jobs
              </TabsTrigger>
            ...
            <TabsContent value="documents" className="space-y-4 animate-fade-in">
              ...
              <div className="grid gap-4">
                {[
                  { name: "Degree Certificate.pdf", size: "2.4 MB", date: "Jan 15, 2024" },
                  { name: "Portfolio.pdf", size: "5.1 MB", date: "Jan 10, 2024" },
                  { name: "ID Document.pdf", size: "1.2 MB", date: "Dec 20, 2023" },
                ].map((doc) => (
                  <Card key={doc.name} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
            ...
            <TabsContent value="reviews" className="space-y-4 animate-fade-in">
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="text-muted-foreground">{reviews.length} reviews • {averageRating.toFixed(1)} average rating</p>
                </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground text-lg mb-4">Full Stack Developer</p>
